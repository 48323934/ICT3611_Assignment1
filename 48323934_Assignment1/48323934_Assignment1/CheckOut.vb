Public Class CheckOut
    ...
    Private Sub CheckOut_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        HomeScreen.ToolStripStatusLabel1.Text = "Guest Checking Out"

    End Sub

    Private Sub CheckOut_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.LostFocus
